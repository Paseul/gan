...
if __name__ == '__main__':
    ...
    #ca_model = multi_gpu_model(ca_model, gpus=2)
    ca_model.compile(loss="binary_crossentropy", optimizer="adam")

    stage1_dis = build_stage1_discriminator()
    #stage1_dis = multi_gpu_model(stage1_dis, gpus=2)
    ...
    dis1_log_dir = 'logs/gradient_tape/' + current_time + '/dis1_loss'
    gen1_log_dir = 'logs/gradient_tape/' + current_time + '/gen1_loss'
    dis1_summary_writer = tf.summary.create_file_writer(dis1_log_dir)
    gen1_summary_writer = tf.summary.create_file_writer(gen1_log_dir)
    ...
    for epoch in range(epochs):
        ...
        """
        with dis1_summary_writer.as_default():
            tf.summary.scalar('loss', np.mean(dis_losses), step=epoch)
        with gen1_summary_writer.as_default():
